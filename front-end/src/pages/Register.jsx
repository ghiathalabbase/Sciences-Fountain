...
import { CSRFSetter, cookieGetter, Field } from "../utils";
  ...
  async function register(event) {
    ...
    if (fieldsNames.every((fieldName) => fields[fieldName].isValid())) {
      ...
      const response = await (
        await fetch(`${domainURL}/auth/register`, {
          method: "POST",
          headers: {
    ...
    userContext.user.is_authenticated === false && (
      <form id="register-form" onSubmit={register}>
        ...
        <div id="country_id">
          ...
          <select name="country_id" onChange={validateField}>
